...
# multiplication here well you will see the magic when you run it when you multiply sting with any number than it
...
# here both the words will add together and give you the answer 'First word Second word'
# so when you use addition instead of multiplication will combine those words and give you a single word.
